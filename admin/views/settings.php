        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    var html = '<p><strong><?php esc_html_e('Last Sync:', 'vietshield-waf'); ?></strong> ' + status.last_sync + '</p>';
                    ...
                    $status.html(html);
                    alert('<?php esc_js(esc_html__('IP whitelist synced successfully!', 'vietshield-waf')); ?>');
                } else {
                    alert('<?php esc_js(esc_html__('Sync failed:', 'vietshield-waf')); ?> ' + response.data);
                }
            },
            error: function() {
                alert('<?php esc_js(esc_html__('An error occurred during sync.', 'vietshield-waf')); ?>');
            },
            complete: function() {
