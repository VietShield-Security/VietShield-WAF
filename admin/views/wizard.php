...
jQuery(document).ready(function($) {
    var vswafCurrentStep = <?php echo (int) $vswaf_current_step; ?>;
    var vswafWizardData = {
        webserver: '<?php echo esc_js($vswaf_webserver); ?>',
        config_method: '<?php echo esc_js($vswaf_config_method); ?>'
    };
    ...
    function saveStep(step, data) {
        $.ajax({
            ...
            data: {
                ...
                nonce: '<?php echo esc_js(wp_create_nonce('vietshield_wizard')); ?>',
                step: step,
                data: data
            }
        });
    ...
    $('.wizard-complete').on('click', function() {
        ...
        $(this).prop('disabled', true).text('<?php esc_html_e('Setting up...', 'vietshield-waf'); ?>');
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    alert(response.data.message || '<?php esc_html_e('An error occurred', 'vietshield-waf'); ?>');
                    $('.wizard-complete').prop('disabled', false);
                }
            },
            error: function() {
                alert('<?php esc_html_e('An error occurred', 'vietshield-waf'); ?>');
                $('.wizard-complete').prop('disabled', false);
            }
        });
    });
