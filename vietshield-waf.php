...
// Plugin constants
define('VIETSHIELD_VERSION', '1.1.2');
...
define('VIETSHIELD_DB_VERSION', '1.1.2');
...
function vietshield_init()
{
    ...
    if (is_admin()) {
        ...
        \VietShield\PluginUpdater::get_instance()->init();
    }
...
/**
 * Early Blocker Setup (scheduled by wizard after completion)
 * Enables early blocking and syncs the blocked IP list
 */
add_action('vietshield_early_blocker_setup', function () {
    ...
    // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log -- WAF debug logging
    error_log('VietShield: Early Blocker setup completed via cron');
});
